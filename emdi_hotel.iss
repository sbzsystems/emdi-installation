...
Source: "hotel.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "view\pos4.tmp"; DestDir: "{%TEMP}"; Flags: ignoreversion; Check: MyProgCheck
...
Source: "dbs\MAINHOTEL.FDB"; DestDir: "{app}\dbs"; DestName: "main.fdb"; Flags: onlyifdoesntexist; Languages: Greek
Source: "dbs\MAINHOTELen.FDB"; DestDir: "{app}\dbs"; DestName: "main.fdb"; Flags: onlyifdoesntexist; Languages: English
...
DefaultDirName={pf}\SBZ systems\EMDI hotel\
UsePreviousAppDir=true
WizardImageFile=images\emdisetup-met.bmp
ShowLanguageDialog=yes
OutputBaseFilename=emdi_hotel
AppId={{4A830CC4-E31C-4183-BA99-1AB86D90C3C4}
InfoAfterFile=
InfoBeforeFile=
VersionInfoCompany=SBZ systems
VersionInfoDescription=EMDI hotel
VersionInfoCopyright=SBZ systems
VersionInfoProductName=EMDI hotel
...
[Icons]
Name: "{userdesktop}\EMDI hotel"; Filename: "{app}\epiloges.exe"; WorkingDir: "{app}"; IconFilename: "{app}\images\desktop-main-icon.ico"; IconIndex: 0
...
Filename: "https://www.sbzsystems.com/download/success.php?lang=el&app=hotel"; Flags: postinstall shellexec runasoriginaluser skipifsilent; Languages: Greek
Filename: "https://www.sbzsystems.com/download/success.php?lang=en&app=hotel"; Flags: postinstall shellexec runasoriginaluser skipifsilent; Languages: English
...
[CustomMessages]
Greek.MyAppName=EMDI - Hotel
English.MyAppName=EMDI - Hotel
...
Filename: "{app}\settings.ini"; Section: "General"; Key: "updateurl"; String: "www.sbzsystems.com/download/emdi_hotel.htm"
