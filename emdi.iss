...
Source: "gasconnector.exe"; DestDir: "{app}"; Flags: ignoreversion; Tasks: gas
;Source: "databox_connector.exe"; DestDir: "{app}"; Flags: ignoreversion; Tasks: databox
Source: "bldrconnector.exe"; DestDir: "{app}"; Flags: ignoreversion; Tasks: sqlserver
Source: "view\pos0.tmp"; DestDir: "{%TEMP}"; Flags: ignoreversion; Check: MyProgCheck
...
;Source: "..\fmu\DATA.000"; DestDir: "{app}\fmu"; Tasks: synthbridge; Check: fmunotexist
...
Source: "dbs\MAIN.FDB"; DestDir: "{app}\dbs"; DestName: "main.fdb"; Flags: onlyifdoesntexist; Languages: Greek
Source: "dbs\MAINen.FDB"; DestDir: "{app}\dbs"; DestName: "main.fdb"; Flags: onlyifdoesntexist; Languages: English
...
Source: "mobile\emdi_stock\templates\template.htm"; DestDir: "{app}\emdi_stock\templates"; Tasks: stock
Source: "mobile\emdi_stock\wwwroot\images\background.jpg"; DestDir: "{app}\emdi_stock\wwwroot\images"; Tasks: stock
Source: "mobile\emdi_stock\wwwroot\css\template.css"; DestDir: "{app}\emdi_stock\wwwroot\css"; Tasks: stock
Source: "mobile\emdi_stock\wwwroot\favicon.ico"; DestDir: "{app}\emdi_stock\wwwroot"; Flags: ignoreversion; Tasks: stock
Source: "mobile\emdi_stock\emdi_stock.exe"; DestDir: "{app}\emdi_stock"; Flags: ignoreversion; Tasks: stock
...
[Icons]
Name: "{userdesktop}\EMDI"; Filename: "{app}\epiloges.exe"; WorkingDir: "{app}"; IconFilename: "{app}\images\desktop-main-icon.ico"
...
Filename: "https://www.sbzsystems.com/download/success.php?lang=el&app=erp"; Flags: postinstall shellexec runasoriginaluser skipifsilent; Languages: Greek
Filename: "https://www.sbzsystems.com/download/success.php?lang=en&app=erp"; Flags: postinstall shellexec runasoriginaluser skipifsilent; Languages: English
...
Name: "gas"; Description: "Σύνδεση με εισροών εκροών"; Flags: unchecked; Languages: Greek
;Name: "databox"; Description: "Σύνδεση με υπηρεσία παραφαρμάκων"; Flags: unchecked; Languages: Greek
Name: "sqlserver"; Description: "Σύνδεση eshop με SQL Server"; Flags: unchecked; Languages: Greek
Name: "eshop"; Description: "Σύνδεση eshop με γέφυρα"; Flags: unchecked; Languages: Greek
...
Name: "gas"; Description: "Fuel inflows, outflows connection"; Flags: unchecked; Languages: English
;Name: "databox"; Description: "Parapharmaceutical database connection"; Flags: unchecked; Languages: English
Name: "sqlserver"; Description: "Eshop connection with SQL Server"; Flags: unchecked; Languages: English
Name: "eshop"; Description: "Eshop connection with bridge"; Flags: unchecked; Languages: English
...
;Filename: "{app}\settings.ini"; Section: "DB"; Key: "host"; String: "localhost"; Flags: createkeyifdoesntexist; Tasks: normal_database
