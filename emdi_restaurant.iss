...
Source: "paraggelies.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "sync.exe"; DestDir: "{app}"; Flags: ignoreversion; Tasks: sync
Source: "view\pos2.tmp"; DestDir: "{%TEMP}"; Flags: ignoreversion; Check: MyProgCheck
...
Source: "dbs\MAINREST.FDB"; DestDir: "{app}\dbs"; DestName: "main.fdb"; Flags: onlyifdoesntexist; Languages: Greek
Source: "dbs\MAINRESTen.FDB"; DestDir: "{app}\dbs"; DestName: "main.fdb"; Flags: onlyifdoesntexist; Languages: English
...
Source: "efoodconnector.exe"; DestDir: "{app}"; Flags: ignoreversion; Tasks: efood
Source: "dbs\CONNECTOR.FDB"; DestDir: "{app}\dbs"; Flags: ignoreversion; Tasks: efood
...
DefaultDirName={pf}\SBZ systems\EMDI restaurant\
UsePreviousAppDir=true
WizardImageFile=images\emdisetup-met.bmp
ShowLanguageDialog=yes
OutputBaseFilename=emdi_restaurant
AppId={{3BD2F47C-A647-421C-AA6B-8CFEC0813139}
InfoAfterFile=
InfoBeforeFile=
VersionInfoCompany=SBZ systems
VersionInfoDescription=EMDI restaurant
VersionInfoCopyright=SBZ systems
VersionInfoProductName=EMDI restaurant
...
[Icons]
Name: "{userdesktop}\EMDI restaurant"; Filename: "{app}\epiloges.exe"; WorkingDir: "{app}"; IconFilename: "{app}\images\desktop-main-icon.ico"; IconIndex: 0
...
Filename: "https://www.sbzsystems.com/download/success.php?lang=el&app=restaurant"; Flags: postinstall shellexec runasoriginaluser skipifsilent; Languages: Greek
Filename: "https://www.sbzsystems.com/download/success.php?lang=en&app=restaurant"; Flags: postinstall shellexec runasoriginaluser skipifsilent; Languages: English
...
Name: "efood"; Description: "Σύνδεση με υπηρεσία delivery"; Flags: unchecked; Languages: Greek
...
Name: "efood"; Description: "Delivery service connection"; Flags: unchecked; Languages: English
...
[CustomMessages]
Greek.MyAppName=EMDI - Restaurant
English.MyAppName=EMDI - Restaurant
...
[INI]
Filename: "{app}\personal\{username}\settings.ini"; Section: "General"; Key: "theme"; String: "Darker"; Flags: createkeyifdoesntexist

Filename: "{app}\settings.ini"; Section: "General"; Key: "updateurl"; String: "www.sbzsystems.com/download/emdi_restaurant.htm"
