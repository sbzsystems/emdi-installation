...
Source: "view\pos5.tmp"; DestDir: "{%TEMP}"; Flags: ignoreversion; Check: MyProgCheck
...
;Source: "view\oposbc.tmp"; DestDir: "{app}"; Flags: ignoreversion; Tasks: spos;
;Source: "view\oposdisplay.tmp"; DestDir: "{app}"; Flags: ignoreversion; Tasks: spos;
;Source: "view\oposdrawer.tmp"; DestDir: "{app}"; Flags: ignoreversion; Tasks: spos;
;Source: "view\oposscale.tmp"; DestDir: "{app}"; Flags: ignoreversion; Tasks: spos;
;Source: "view\oposweight.tmp"; DestDir: "{app}"; Flags: ignoreversion; Tasks: spos;
...
Source: "view\settings.ini"; DestDir: "{app}"; DestName: "settings.ini"; Flags: onlyifdoesntexist
...
Source: "dbs\MAINPARK.FDB"; DestDir: "{app}\dbs"; DestName: "main.fdb"; Flags: onlyifdoesntexist; Languages: Greek
Source: "dbs\MAINPARKen.FDB"; DestDir: "{app}\dbs"; DestName: "main.fdb"; Flags: onlyifdoesntexist; Languages: English
...
Source: "mobile\emdi_park\ticket_en.txt"; DestDir: "{app}\emdi_park\"; DestName: "ticket.txt"; Flags: onlyifdoesntexist; Languages: English
Source: "mobile\emdi_park\receipt_en.txt"; DestDir: "{app}\emdi_park\"; DestName: "receipt.txt"; Flags: onlyifdoesntexist; Languages: English

Source: "mobile\emdi_park\ticket.txt"; DestDir: "{app}\emdi_park\"; DestName: "ticket.txt"; Flags: onlyifdoesntexist; Languages: Greek
Source: "mobile\emdi_park\receipt.txt"; DestDir: "{app}\emdi_park\"; DestName: "receipt.txt"; Flags: onlyifdoesntexist; Languages: Greek

Source: "mobile\emdi_park\emdi_park.exe"; DestDir: "{app}\emdi_park"; Flags: ignoreversion
...
DefaultDirName={pf}\SBZ systems\EMDI park\
UsePreviousAppDir=true
WizardImageFile=images\emdisetup-met.bmp
ShowLanguageDialog=yes
OutputBaseFilename=emdi_park
AppId={{BE9B4EE6-6E3D-486B-93D7-C81489DE0A1F}
InfoAfterFile=
InfoBeforeFile=
VersionInfoCompany=SBZ systems
VersionInfoDescription=EMDI park
VersionInfoCopyright=SBZ systems
VersionInfoProductName=EMDI park
...
[Icons]
Name: "{userdesktop}\EMDI park"; Filename: "{app}\epiloges.exe"; WorkingDir: "{app}"; IconFilename: "{app}\images\desktop-main-icon.ico"; IconIndex: 0
...
Filename: "https://www.sbzsystems.com/download/success.php?lang=el&app=park"; Flags: postinstall shellexec runasoriginaluser skipifsilent; Languages: Greek
Filename: "https://www.sbzsystems.com/download/success.php?lang=en&app=park"; Flags: postinstall shellexec runasoriginaluser skipifsilent; Languages: English
...
Name: "spos"; Description: "Γέφυρα σύνδεσης με συσκευές RS-232"; Flags: unchecked; Languages: Greek
Name: "display"; Description: "Οθόνη πελάτη"; Flags: unchecked; Languages: Greek
...
Name: "spos"; Description: "RS-232 device connector"; Flags: unchecked; Languages: English
Name: "display"; Description: "Customer display"; Flags: unchecked; Languages: English
...
[CustomMessages]
Greek.MyAppName=EMDI - Park
English.MyAppName=EMDI - Park
...
[INI]
Filename: "{app}\settings.ini"; Section: "General"; Key: "updateurl"; String: "www.sbzsystems.com/download/emdi_park.htm"
...
Filename: "{app}\emdi_park\park.ini"; Section: "General"; Key: "customercode"; String: "/"
Filename: "{app}\emdi_park\park.ini"; Section: "General"; Key: "productcode"; String: "000"

Filename: "{app}\personal\{username}\settings.ini"; Section: "General"; Key: "theme"; String: "dark"; Flags: createkeyifdoesntexist
...
//ΤΕΡΜΑΤΙΣΜΟΣ ΕΦΑΡΜΟΓΩΝ ΠΟΥ ΤΡΕΧΟΥΝ
...
begin
  ...
  PrintButton.Visible := CurPage = wpLicense;
    ...
    if CurPage = wpFinished then WizardForm.RunList.Visible := False;
